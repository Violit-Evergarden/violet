...
from app.services.audio import AudioError, check_ffmpeg_available, extract_audio, get_audio_info
from app.services.downloader import DownloadError, download_video
from app.services.link_parser import LinkParserError, parse_share_text
from app.services.transcriber import SenseVoiceTranscriber, TranscriberError
...
def extract_transcript(share_text: str) -> ExtractResponse:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="video_to_text_", dir=settings.temp_dir))
